...
int CineMap::detectCadence(const QString& tbcFilePath) {
  ...
  // 2. Segmentation by edit boundaries
  ...
  // What remains unknown after pattern, facts and anchored healing have all
  // declined is the unanchored residue, and it reads
