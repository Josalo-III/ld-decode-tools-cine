...
void JsonReader::read(qint64 &value) { readSignedInteger(value); }
...
void JsonWriter::write(qint64 value) { output << value; }
...
void JsonWriter::write(const QString &value) { writeString(value.toUtf8()); }
