...
// system. See the comments in VideoParameters for the meanings of these values.
...
static constexpr VideoSystemDefaults ntscDefaults{
    ...
    20,
    259,
    // Interlaced line 40 is NTSC line 21 (the closed-caption line before the
    // first active half-line) Interlaced line 524 is NTSC line 263 (the last
    // active half-line)
    40,
    525,
};
...
static const VideoSystemDefaults &getSystemDefaults(
    const ExportMetaData::VideoParameters &videoParameters) {
...
bool ExportMetaData::parseVideoSystemName(QString name,
                                          ExportMetaData::VideoSystem &system) {
...
void ExportMetaData::VideoParameters::read(JsonReader &reader) {
  ...
  if (systemString == "") {
    ...
    if (isSourcePal) {
      ...
      system = NTSC;
  } else if (!parseVideoSystemName(QString::fromStdString(systemString),
                                   system)) {
...
// Read Ntsc from JSON
void ExportMetaData::Ntsc::read(JsonReader &reader,
...
ExportMetaData::ExportMetaData() { clear(); }
...
void ExportMetaData::setVideoParameters(
    const ExportMetaData::VideoParameters &_videoParameters) {
  videoParameters = _videoParameters;
  videoParameters.isValid = true;
}

// This method returns the pcmAudioParameters metadata
const ExportMetaData::PcmAudioParameters &
ExportMetaData::getPcmAudioParameters() {
  assert(pcmAudioParameters.isValid);
  return pcmAudioParameters;
}

// This method sets the pcmAudioParameters metadata
void ExportMetaData::setPcmAudioParameters(
    const ExportMetaData::PcmAudioParameters &_pcmAudioParameters) {
...
void ExportMetaData::processLineParameters(
    ExportMetaData::LineParameters &lineParameters) {
  lineParameters.applyTo(videoParameters);
}

// Validate and apply to a set of VideoParameters
void ExportMetaData::LineParameters::applyTo(
    ExportMetaData::VideoParameters &videoParameters) {
  ...
  if (firstActiveFieldLine < 1 || firstActiveFieldLine > defaultLastFieldLine) {
    if (firstFieldLineExists) {
      qInfo().nospace() << "Specified first active field line "
                        << firstActiveFieldLine << " out of bounds (1 to "
                        << defaultLastFieldLine << "), resetting to default ("
                        << defaultFirstFieldLine << ").";
    }
  ...
  if (lastActiveFieldLine < 1 || lastActiveFieldLine > defaultLastFieldLine) {
    if (lastFieldLineExists) {
      qInfo().nospace() << "Specified last active field line "
                        << lastActiveFieldLine << " out of bounds (1 to "
                        << defaultLastFieldLine << "), resetting to default ("
  ...
  if (firstActiveFieldLine > lastActiveFieldLine) {
    qInfo().nospace() << "Specified last active field line "
                      << lastActiveFieldLine
                      << " is before specified first active field line"
                      << firstActiveFieldLine << ", resetting to defaults ("
                      << defaultFirstFieldLine << "-" << defaultLastFieldLine
                      << ").";
    firstActiveFieldLine = defaultFirstFieldLine;
    lastActiveFieldLine = defaultLastFieldLine;
  }
  ...
  if (firstActiveFrameLine < minFirstFrameLine ||
    ...
    if (firstFrameLineExists) {
      qInfo().nospace() << "Specified first active frame line "
                        << firstActiveFrameLine << " out of bounds ("
                        << minFirstFrameLine << " to " << defaultLastFrameLine
                        << "), resetting to default (" << defaultFirstFrameLine
                        << ").";
    }
  ...
  if (lastActiveFrameLine < minFirstFrameLine ||
    ...
    if (lastFrameLineExists) {
      qInfo().nospace() << "Specified last active frame line "
                        << lastActiveFrameLine << " out of bounds ("
                        << minFirstFrameLine << " to " << defaultLastFrameLine
                        << "), resetting to default (" << defaultLastFrameLine
                        << ").";
    }
    lastActiveFrameLine = defaultLastFrameLine;
  }
  ...
  if (firstActiveFrameLine > lastActiveFrameLine) {
    qInfo().nospace() << "Specified last active frame line "
                      << lastActiveFrameLine
                      << " is before specified first active frame line"
                      << firstActiveFrameLine << ", resetting to defaults ("
                      << defaultFirstFrameLine << "-" << defaultLastFrameLine
                      << ").";
    firstActiveFrameLine = defaultFirstFrameLine;
    lastActiveFrameLine = defaultLastFrameLine;
  }
...
const ExportMetaData::Field &ExportMetaData::getField(
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "ExportMetaData::getField(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
// number
const ExportMetaData::VitsMetrics &ExportMetaData::getFieldVitsMetrics(
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
        << "ExportMetaData::getFieldVitsMetrics(): Requested field number"
        << sequentialFieldNumber << "out of bounds!";
  }
...
const ExportMetaData::Vbi &ExportMetaData::getFieldVbi(
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "ExportMetaData::getFieldVbi(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
const ExportMetaData::Ntsc &ExportMetaData::getFieldNtsc(
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "ExportMetaData::getFieldNtsc(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
const ExportMetaData::Vitc &ExportMetaData::getFieldVitc(
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "ExportMetaData::getFieldVitc(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
// field number
const ExportMetaData::ClosedCaption &ExportMetaData::getFieldClosedCaption(
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
        << "ExportMetaData::getFieldClosedCaption(): Requested field number"
        << sequentialFieldNumber << "out of bounds!";
  }
...
// number
const ExportDropOuts &ExportMetaData::getFieldDropOuts(
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "ExportMetaData::getFieldDropOuts(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
void ExportMetaData::updateField(const ExportMetaData::Field &field,
                                 qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
        << "ExportMetaData::updateFieldVitsMetrics(): Requested field number"
        << sequentialFieldNumber << "out of bounds!";
  }
...
void ExportMetaData::updateFieldVitsMetrics(
    const ExportMetaData::VitsMetrics &vitsMetrics,
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
...
// This method sets the field VBI metadata for a field
void ExportMetaData::updateFieldVbi(const ExportMetaData::Vbi &vbi,
                                    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "ExportMetaData::updateFieldVbi(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
void ExportMetaData::updateFieldNtsc(const ExportMetaData::Ntsc &ntsc,
                                     qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "ExportMetaData::updateFieldNtsc(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
void ExportMetaData::updateFieldVitc(const ExportMetaData::Vitc &vitc,
                                     qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "ExportMetaData::updateFieldVitc(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
void ExportMetaData::updateFieldClosedCaption(
    const ExportMetaData::ClosedCaption &closedCaption,
    qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
        << "ExportMetaData::updateFieldClosedCaption(): Requested field number"
        << sequentialFieldNumber << "out of bounds!";
  }
...
void ExportMetaData::updateFieldDropOuts(const ExportDropOuts &dropOuts,
                                         qint32 sequentialFieldNumber) {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
        << "ExportMetaData::updateFieldDropOuts(): Requested field number"
        << sequentialFieldNumber << "out of bounds!";
  }
...
void ExportMetaData::clearFieldDropOuts(qint32 sequentialFieldNumber) {
  ...
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
        << "ExportMetaData::clearFieldDropOuts(): Requested field number"
        << sequentialFieldNumber << "out of bounds!";
  }
...
qint32 ExportMetaData::getNumberOfFields() { return fields.size(); }
...
// they should be combined to make a 'frame'.  Basically, (taking NTSC as an
// example) a frame consists of frame lines numbered from 1 to 525.  A frame is
// made from two fields, one field contains field lines 1 to 262.5 and another
// 263 to 525 (although for convenence the 'half-lines' are usually treated as
// one full line and ignored so both fields contain a total of 263 lines of
// which 1 is ignored).
//
// When a frame is created, the field containing field lines 1-263 is interlaced
// with the field containing 263-525 creating a frame with field lines 1, 263,
// 2, 264 and so on.  This 'frame' is then considered to contain frame lines
// 1-525.
//
// The field containing the first line of the frame is called the 'first field'
// and the field containing the second line of the frame is called the 'second
// field'.
//
// However, other names exist:
//
// Even/Odd - where the 'odd' field contains the odd line numbers 1, 3, 5, etc.
// This is the same as the 'first' field so odd = first and even = second.
//
// Upper/lower - where the 'upper' field contains the upper-part of each
// combination. This is the same as the first field so upper = first and lower =
// second.
//
// With a standard TV, as long as one field is first and the other is second,
// the only thing a TV requires is that the sequence of fields is constant. They
// are simply displayed one set of fields after another to form a frame which is
// part of a moving image.
//
...
// in the order first field/second field = still-frame or second field/first
// field = still frame.
//
// This is why the following methods use the "isFirstFieldFirst" flag (which is
// a little confusing in itself).
//
// There are two ways to determine the 'isFirstFieldFirst'.  The first method is
// by user observation (it's pretty clear on a still-frame when it is wrong),
// the other (used by LaserDisc players) is to look for a CAV picture number in
// the VBI data of the field.  The IEC specification states that the picture
// number should only be in the first field of a frame. (Note: CLV discs don't
// really have to follow this as there are no 'still-frames' allowed by the
// original format).
//
// This gets even more confusing for NTSC discs using pull-down, where the
// sequence of fields making up the frames isn't even, so some field-pairs
// aren't considered to contain the first field of a still-frame (and when
// pausing the LaserDisc player will never use certain fields to render the
// still-frame).  Wikipedia is your friend if you want to learn more about it.
//
// Determining the correct setting of 'isFirstFieldFirst' is therefore outside
// of the shared-library scope.
...
qint32 ExportMetaData::getFieldNumber(qint32 frameNumber, qint32 field) {
  ...
  while (!getField(firstFieldNumber).isFirstField) {
    ...
    if (firstFieldNumber > getNumberOfFields() ||
      ...
      qCritical() << "Attempting to get field number failed - no isFirstField "
                     "in JSON before end of file";
      firstFieldNumber = -1;
      secondFieldNumber = -1;
      break;
    }
  ...
  if (firstFieldNumber > getNumberOfFields()) {
    qCritical() << "ExportMetaData::getFieldNumber(): First field number "
                   "exceed the available number of fields!";
    firstFieldNumber = -1;
    secondFieldNumber = -1;
  }
  ...
  if (secondFieldNumber > getNumberOfFields()) {
    qCritical() << "ExportMetaData::getFieldNumber(): Second field number "
                   "exceed the available number of fields!";
    firstFieldNumber = -1;
    secondFieldNumber = -1;
  }
  ...
  if (getField(secondFieldNumber).isFirstField) {
    qCritical()
        << "ExportMetaData::getFieldNumber(): Both of the determined fields "
...
bool ExportMetaData::getIsFirstFieldFirst() { return isFirstFieldFirst; }

// Method to convert a CLV time code into an equivalent frame number (to make
// processing the timecodes easier)
qint32 ExportMetaData::convertClvTimecodeToFrameNumber(
...
ExportMetaData::ClvTimecode ExportMetaData::convertFrameNumberToClvTimecode(
    qint32 frameNumber) {
...
// Private method to generate a map of the PCM audio data (used by the
// sourceAudio library) Note: That the map unit is "stereo sample pairs"; so
// each unit represents 2 16-bit samples for a total of 4 bytes per unit.
void ExportMetaData::generatePcmAudioMap() {
  pcmAudioFieldStartSampleMap.clear();
  pcmAudioFieldLengthMap.clear();

  qDebug()
      << "ExportMetaData::generatePcmAudioMap(): Generating PCM audio map...";
  ...
  for (qint32 fieldNo = 0; fieldNo < numberOfFields; fieldNo++) {
    ...
    pcmAudioFieldLengthMap[fieldNo] =
        static_cast<qint32>(getField(fieldNo + 1).audioSamples);

    if (fieldNo == 0) {
      // First field starts at 0 units
      pcmAudioFieldStartSampleMap[fieldNo] = 0;
    } else {
      // Every following field's start position is the start+length of the
      // previous
      pcmAudioFieldStartSampleMap[fieldNo] =
          pcmAudioFieldStartSampleMap[fieldNo - 1] +
          pcmAudioFieldLengthMap[fieldNo - 1];
    }
  }
}
