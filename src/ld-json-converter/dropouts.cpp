...
DropOuts::DropOuts(const QVector<qint32> &startx, const QVector<qint32> &endx,
...
// Append a dropout
void DropOuts::append(const qint32 startx, const qint32 endx,
...
void DropOuts::concatenate(const bool verbose) {
  ...
  if (verbose) {
    tbcDebugStream() << "Concatenated dropouts: was" << sizeAtStart << "now"
