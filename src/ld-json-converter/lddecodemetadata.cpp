...
void LdDecodeMetaData::Field::read(JsonReader &reader) {
  ...
  while (reader.readMember(member)) {
    if (member == "audioSamples")
    ...
    else if (member == "cadenceConfidence")
      reader.read(cadenceConfidence);
    else if (member == "cadenceId")
      reader.read(cadenceId);
    else if (member == "cadenceIndexPresumed")
      reader.read(cadenceIndexPresumed);
      ...
      reader.read(pad);
    else if (member == "pulldownRole")
      reader.read(pulldownRole);
...
const LdDecodeMetaData::Field &LdDecodeMetaData::getField(
    qint32 sequentialFieldNumber) const {
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::getField(): Requested field number"
...
const LdDecodeMetaData::Vbi &LdDecodeMetaData::getFieldVbi(
  ...
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::getFieldVbi(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
const LdDecodeMetaData::Ntsc &LdDecodeMetaData::getFieldNtsc(
  ...
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::getFieldNtsc(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
const LdDecodeMetaData::Vitc &LdDecodeMetaData::getFieldVitc(
  ...
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::getFieldVitc(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
  }
...
const DropOuts &LdDecodeMetaData::getFieldDropOuts(
  ...
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
        << "LdDecodeMetaData::getFieldDropOuts(): Requested field number"
        << sequentialFieldNumber << "out of bounds!";
  }
...
void LdDecodeMetaData::updateField(const LdDecodeMetaData::Field &field,
  ...
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::updateField(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
    return;
  }
...
void LdDecodeMetaData::updateFieldVbi(const LdDecodeMetaData::Vbi &vbi,
  ...
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::updateFieldVbi(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
    return;
  }
...
void LdDecodeMetaData::updateFieldNtsc(const LdDecodeMetaData::Ntsc &ntsc,
  ...
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::updateFieldNtsc(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
    return;
  }
...
void LdDecodeMetaData::updateFieldVitc(const LdDecodeMetaData::Vitc &vitc,
  ...
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::updateFieldVitc(): Requested field number"
                << sequentialFieldNumber << "out of bounds!";
    return;
  }
...
void LdDecodeMetaData::updateFieldClosedCaption(
  ...
  qint32 fieldNumber = sequentialFieldNumber - 1;
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::updateFieldClosedCaption(): Requested "
                   "field number"
                << sequentialFieldNumber << "out of bounds!";
    return;
  }
...
void LdDecodeMetaData::clearFieldDropOuts(qint32 sequentialFieldNumber) {
  ...
  if (fieldNumber < 0 || fieldNumber >= getNumberOfFields()) {
    qCritical()
        << "LdDecodeMetaData::clearFieldDropOuts(): Requested field number"
        << sequentialFieldNumber << "out of bounds!";
    return;
  }
...
qint32 LdDecodeMetaData::getNumberOfFields() const { return fields.size(); }
...
// of the shared-library scope. That task is now performed in ld-cinemap.
...
qint32 LdDecodeMetaData::getFieldNumber(qint32 frameNumber, qint32 field) {
  ...
  if (firstFieldNumber > getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::getFieldNumber(): First field number "
  ...
  if (secondFieldNumber > getNumberOfFields()) {
    qCritical() << "LdDecodeMetaData::getFieldNumber(): Second field number "
                   "exceed the available number of fields!";
    firstFieldNumber = -1;
    secondFieldNumber = -1;
  }
...
qint32 LdDecodeMetaData::convertClvTimecodeToFrameNumber(
