 ...
 * File:        main.cpp
 * Module:      cli
 * Purpose:     Command-line entry point for VITS metric extraction
 *
...
int main(int argc, char* argv[]) {
  ...
  if (inputMetadataFilename == outputMetadataFilename && !noBackup) {
    qInfo().nospace().noquote()
        << "Backing up metadata to " << inputMetadataFilename << ".vbup";
  ...
  ProcessingPool processingPool(inputFilename, outputMetadataFilename,
                                maxThreads, metaData);
