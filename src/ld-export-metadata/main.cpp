 ...
 * File:        main.cpp
 * Module:      cli
 * Purpose:     Command-line entry point for the ld-export-metadata tool
 *
 * SPDX-License-Identifier: GPL-3.0-or-later
 * SPDX-FileCopyrightText: 2020-2023 Adam Sampson
 * SPDX-FileCopyrightText: 2021-2025 Simon Inns
 */
...
int main(int argc, char *argv[]) {
  ...
  QCommandLineOption writeAudacityLabelsOption(
      ...
      QCoreApplication::translate(
          "main", "Write navigation information as Audacity labels"),
      QCoreApplication::translate("main", "file"));
  ...
  QCommandLineOption writeFfmetadataOption(
      "ffmetadata",
      QCoreApplication::translate(
          "main", "Write navigation information as FFMETADATA1"),
      QCoreApplication::translate("main", "file"));
  ...
  QCommandLineOption writeClosedCaptionsOption(
      "closed-captions",
      QCoreApplication::translate(
          "main", "Write closed captions as Scenarist SCC V1.0 format"),
      QCoreApplication::translate("main", "file"));
