 ...
 * File:        main.cpp
 * Module:      cli
 * Purpose:     Command-line entry point for the ld-lds-converter tool
 *
 * SPDX-License-Identifier: GPL-3.0-or-later
 * SPDX-FileCopyrightText: 2019-2020 Simon Inns
 */
...
int main(int argc, char *argv[]) {
  ...
  QCommandLineOption sourceVideoFileOption(
      QStringList() << "i" << "input",
      QCoreApplication::translate(
          "main", "Specify input laserdisc sample file (default is stdin)"),
      QCoreApplication::translate("main", "file"));
  parser.addOption(sourceVideoFileOption);

  // Option to specify output video file (-o)
  QCommandLineOption targetVideoFileOption(
      QStringList() << "o" << "output",
      QCoreApplication::translate(
          "main", "Specify output laserdisc sample file (default is stdout)"),
      QCoreApplication::translate("main", "file"));
  parser.addOption(targetVideoFileOption);

  // Option to unpack 10-bit data (-u)
  QCommandLineOption showUnpackOption(
      QStringList() << "u" << "unpack",
      QCoreApplication::translate("main",
                                  "Unpack 10-bit data into 16-bit (default)"));
  parser.addOption(showUnpackOption);

  // Option to pack 16-bit data (-p)
  QCommandLineOption showPackOption(
      QStringList() << "p" << "pack",
  ...
  QCommandLineOption showRIFFOption(
      QStringList() << "r" << "riff",
      QCoreApplication::translate("main",
                                  "Unpack 10-bit data into 16-bit with RIFF "
                                  "WAV headers (use this ONLY for FlaCCL)"));
